...
dmod_dmspi_api_declaration(1.0, dmspi_t, _create, ( void ))
{
    ...
    struct dmspi *instance = Dmod_Malloc(sizeof(*instance));
    if (instance == NULL)
    {
        return NULL;
    }
...
dmod_dmspi_api_declaration(1.0, void, _destroy, ( dmspi_t handle ))
{
    Dmod_Free(handle);
}

dmod_dmspi_api_declaration(1.0, bool, _is_valid, ( dmspi_t handle ))
{
